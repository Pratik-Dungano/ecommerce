...
const Lehenga = () => {
  ...
  const sareeProducts = products.filter(product => 
    product.subcategory?.toLowerCase() === 'lengha'
  );
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-semibold text-gray-900 mb-4">Lehenga Collection</h1>
      ...
      {sareeProducts.length === 0 ? (
        <div className="text-center py-12">
          <p className="text-gray-500 text-lg">No lehenga available at the moment.</p>
        </div>
      ) : (
